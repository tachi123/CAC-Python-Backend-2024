...
#catalogo = Catalogo(host='127.0.0.1', port='4002', user='tachi123', password='123456',database='myapp')
catalogo = Catalogo(host='tachi123.mysql.pythonanywhere-services.com', user='tachi123', password='Prueba123', database='tachi123$myapp')
...
def agregar_producto():
    ...
    if nuevo_codigo:
        ...
        return jsonify({"mensaje": "Producto agregado correctamente.", "codigo": nuevo_codigo, "descripción": descripcion}), 201
    else:
